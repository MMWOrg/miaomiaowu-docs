    ...
    <>
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          ...
          >
            <span className='sr-only'>{t('userMenu.ariaLabel', { name: displayName })}</span>
        ...
        <DropdownMenuContent align='end' className='w-56 space-y-3 p-4'>
          ...
          <DropdownMenuItem asChild className='cursor-pointer justify-center'>
            <Link to='/settings' className='flex items-center gap-2'>
              <Settings2 className='size-4' /> {t('userMenu.personalSettings')}
            </Link>
          </DropdownMenuItem>
          <DropdownMenuItem asChild className='cursor-pointer justify-center'>
          ...
          {profile?.is_admin && (
            <DropdownMenuItem onClick={() => setBackupDialogOpen(true)} className='cursor-pointer justify-center'>
              <HardDrive className='size-4' /> {t('userMenu.backupData')}
            </DropdownMenuItem>
          )}
          {profile?.is_admin && (
          ...
          <DropdownMenuItem asChild className='cursor-pointer justify-center'>
            ...
            >
              ...
              {t('userMenu.version')}{currentVersion}
            </a>
          </DropdownMenuItem>
          <DropdownMenuSeparator />
