...
// node_modules/@tanstack/router-devtools-core/dist/index-Bz4rofgr.js
  ...
  mount(el) {
    ...
    const dispose2 = render(() => {
      ...
      if (this.#Component) {
        ...
        Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-KvPiI7YB-77MSLQNU.js"));
  ...
  mount(el) {
    ...
    const dispose2 = render(() => {
      ...
      if (this.#Component) {
        ...
        BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-Cbvcs84k-XHJQ4FQ4.js").then((n) => n.c));
...
//# sourceMappingURL=chunk-NPKHYTL2.js.map
