  ...
  mount(el) {
    ...
    const dispose = web.render(() => {
      ...
      if (this.#Component) {
        ...
        Devtools = solidJs.lazy(() => Promise.resolve().then(() => require("./FloatingTanStackRouterDevtools-BMhRQRk5.cjs")));
  ...
  mount(el) {
    ...
    const dispose = web.render(() => {
      ...
      if (this.#Component) {
        ...
        BaseTanStackRouterDevtoolsPanel = solidJs.lazy(() => Promise.resolve().then(() => require("./BaseTanStackRouterDevtoolsPanel-CiObEXSM.cjs")).then((n) => n.BaseTanStackRouterDevtoolsPanel$1));
...
//# sourceMappingURL=index-sVJ8jjbP.cjs.map
