  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (this.#Component) {
        ...
        Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-KvPiI7YB.js"));
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (this.#Component) {
        ...
        BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-Cbvcs84k.js").then((n) => n.c));
...
//# sourceMappingURL=index-Bz4rofgr.js.map
